...
export default class IndonesiaScene extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "IndonesiaScene" });
    }

    create() {
        this.add.image(400, 300, "indonesia");
        ...
        this.player = this.physics.add.sprite(800, 180, "dude");
        ...
        this.star = this.physics.add.sprite(600, 500, "star");
    ...
    private handleCollectStar(player: Collidable, s: Collidable) {
        ...
        this.scene.start("ThailandScene");
    }
